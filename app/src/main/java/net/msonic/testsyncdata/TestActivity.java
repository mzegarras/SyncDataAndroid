...
public class TestActivity extends BaseSpiceActivity {
    ...
    RequestListener<String> listener = new RequestListener<String>() {
        ...
        public void onRequestFailure(SpiceException spiceException) {
            Log.d(TestActivity.class.getCanonicalName(),String.valueOf(getSpiceManager().getPendingRequestCount()));
    ...
    public void btnAdd(View view){
        ...
        Log.d(TestActivity.class.getCanonicalName(),"Ok");
    }
